...
data = webdata.get_data_yahoo(tickers=symbol, start=start,end=end) # yf.download()
print(data)
...
test_data = webdata.get_data_yahoo(tickers=symbol, start=test_start,end=test_end) # yf.download()


#test_data = web.DataReader('META', 'yahoo', test_start, test_end)
...
print(f"Predilction: {prediction}")
